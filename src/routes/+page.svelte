...
>
	...
	>
		<div
			class="w-full max-w-[500px] h-[540px] relative flex flex-col justify-between p-6 border bg-black border-0"
		>
			<div class="font-['Funnel_Display'] text-xl text-white select-none">hi, i'm</div>
			<div class="flex flex-col items-center justify-center relative my-auto">
				<span
					class="absolute left-0 md:left-2 top-1/2 -translate-y-1/2 text-[#ff69b4] text-2xl md:text-3xl select-none inline-block animate-cute-rotate"
					>✦</span
				>
				<h1
					class="font-['Instrument_Serif'] text-[#16e16e] text-6xl md:text-[9.5rem] leading-none tracking-tight text-center w-full select-none"
				>
					manik
				</h1>
				<span
					class="absolute right-0 md:right-2 top-1/2 -translate-y-1/2 text-[#ff69b4] text-2xl md:text-3xl select-none inline-block animate-cute-rotate-reverse"
					>✦</span
				>
			</div>
			<div
			...
			>
				<span class="h-10 w-full relative overflow-hidden inline-block">
					{#key quote}
						<span
							class="font-['Instrument_Serif'] text-[#ff69b4] text-2xl md:text-3xl absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 inline-block whitespace-nowrap text-center w-full"
	...
	<section
		class="h-screen w-full snap-start flex flex-col items-center justify-center text-center py-16 gap-6 font-['Funnel_Display'] shrink-0 overflow-y-auto px-4"
	>
		<div class="max-w-xl mx-auto space-y-3 px-4 text-sm md:text-base text-gray-300">
		...
		<div class="text-[11px] text-gray-400 mt-2 max-w-md">
			<span class="italic">psst</span> want to listen to a banger song?<br />
			<a
...
<style>
	...
	.animate-cute-rotate {
		animation: cuteRotate 4s ease-in-out infinite;
	}
